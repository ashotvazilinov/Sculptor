...
def Factory_Options_renaming(sf):
    ...
    Bundle_Full_name = ["WWW - 001", "WWW - 002"]
    Old_Feature_Name = "test Number two"
    New_Feature_Name = "Testing test Number two"
    # for i in Bundle_first_name:

    for x in Bundle_Full_name:
        print(f"\n=== Processing bundle mask: {x} ===")
        bundles = sf.query(
            f"SELECT Id, Name FROM Product2 WHERE Name = '{x}' and RecordType.name = 'Product Bundle' and IsActive = true"
        )
        ...
        for bundle in bundles["records"]:
            ...
            feature_result = sf.query(
                ...
                AND SCLP__Product__c = '{bundle_id}' and SCLP__Product__r.IsActive = true
                """
            )
            ...
            #     SELECT Id, Name
            #     FROM SCLP__ProductFeature__c
            #     WHERE Name LIKE '%test Number two%'
...
def Move_iCommand (sf):
    ...
    Bundle_Full_name = ['NxB08 - Base Mounted',
        'NxB08 - Base Mounted w/ Integrated Dryer',
        'NxB08 - Tank Mounted (80 Gal.)',
        'NxB08 - Ultra Pack (80 Gal.)',
        'NxB11 - Base Mounted',
        'NxB11 - Base Mounted w/ Integrated Dryer',
        'NxB11 - Tank Mounted (80 Gal.)',
        'NxB11 - Ultra Pack (80 Gal.)',
        'NxB15 - Base Mounted',
        'NxB15 - Base Mounted w/ Integrated Dryer',
        'NxB15 - Tank Mounted (80 Gal.)',
        'NxB15 - Ultra Pack (80 Gal.)',
        'NxB18 - Base Mounted',
        'NxB18 - Base Mounted w/ Integrated Dryer',
        'NxB18 - Tank Mounted (120 Gal.)',
        'NxB18 - Ultra Pack (120 Gal.)',
        'NxB22 - Base Mounted',
        'NxB22 - Base Mounted w/ Integrated Dryer',
        'NxB22 - Tank Mounted (120 Gal.)',
        'NxB22 - Ultra Pack (120 Gal.)',
        'NxB30 - Base Mounted',
        'NxB30 - Base Mounted w/ Integrated Dryer',
        'NxB37 - Base Mounted',
        'NxB37 - Base Mounted w/ Integrated Dryer',]
    Feature_Name_moved_to = "Factory Options (Built in machine prior to shipping)"
    Product_name = "iCommand-Touch+ Electronic Controller Mounted"
    ...
    for x in Bundle_Full_name:
        ...
        for bundle in bundles["records"]:
            ...
            option_result = sf.query(
                ...
                AND SCLP__Bundle__c = '{bundle_id}' and SCLP__Bundle__r.IsActive = true and SCLP__Feature__r.name = 'Controller'
                """
            ...
            factory_option_feature = sf.query(
                ...
                AND SCLP__Bundle__c = '{bundle_id}' and SCLP__Bundle__r.IsActive = true
                """
            ...
            if len(Qty_of_options_in_old_result['records']) == 0:
                ...
                print(f'♻️Feature {old_feature_name} is deleted from bundle {bundle_name}')
# Move_iCommand(sf)    
...
'NxB15 - Base Mounted w/ Integrated Dryer',]
    ...
    Product_name = "Adder for 80-120 Gallon Tank"
    ...
    for x in Bundle_Full_name:
        ...
        for bundle in bundles["records"]:
            ...
            option_result = sf.query(
                ...
                AND SCLP__Bundle__r.IsActive = true
                """
            )
            ...
            option = option_result["records"][0]
            option_id = option["Id"]

            print(f"✔ Option found: {option['SCLP__Product__r']['Name']} ({option_id})")
            # factory_option_feature = sf.query(
            #     f"""
            #     SELECT Id, SCLP__Feature__c, SCLP__Order__c
            #     FROM SCLP__ProductOption__c
            ...
            old_feature_result = sf.query(
                ...
                SELECT Id, SCLP__Product__r.Name, SCLP__Feature__c, SCLP__Feature__r.Name
                FROM SCLP__ProductOption__c
                WHERE Id = '{option_id}' and SCLP__Bundle__r.IsActive = true
                """
            )
            old_feature_id = old_feature_result['records'][0]['SCLP__Feature__c']
            old_feature_name = old_feature_result['records'][0]['SCLP__Feature__r']['Name']
            ...
            sf.SCLP__ProductOption__c.delete(
                option_id                )
            print(f'🗑 Option {option_id} is deleted')
            Qty_of_options_in_old_result = sf.query(
                f"""
                SELECT Id, SCLP__Product__r.name 
                from SCLP__ProductOption__c 
            ...
            if len(Qty_of_options_in_old_result['records']) == 0:
                sf.SCLP__ProductFeature__c.delete(old_feature_id)
                print(f'♻️ Feature {old_feature_name} is deleted from bundle {bundle_name}')
...
def delete_feature_from_bundle(sf):
    Bundle_Full_name = ['NxB18 - Base Mounted',
'NxB18 - Base Mounted w/ Integrated Dryer',
'NxB18 - Tank Mounted (120 Gal.)',
'NxB18 - Ultra Pack (120 Gal.)',]

    # Feature_Name_moved_to = "Feature Number One"
    Feature_name = "Accessories (Shipped Loose): NxB18"
    ...
    for x in Bundle_Full_name:
        ...
        for bundle in bundles["records"]:
            ...
            result = sf.SCLP__ProductFeature__c.delete(feature_id)
            print(result)
            print(f'♻️feature {feature_id} is deleted')
...
def create_bundle_WWW_001_1(sf): #1
    ...
    if len(bundle_query_result.get('records')) >= 1:
        ...
        first_feature_id = sf.query(f"select id from SCLP__ProductFeature__c where SCLP__Order__c = 2 and SCLP__Product__c = '{created_bundle_id}'")['records'][0]['Id']
        ...
        sf.SCLP__ProductFeature__c.create({
            ...
            'SCLP__Tip__c': 'Feature test Number two tip'
        })

        second_feature_id = sf.query(f"select id from SCLP__ProductFeature__c where SCLP__Order__c = 1 and SCLP__Product__c = '{created_bundle_id}'")['records'][0]['Id']
